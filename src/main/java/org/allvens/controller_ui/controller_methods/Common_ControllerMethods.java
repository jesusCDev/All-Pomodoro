package org.allvens.controller_ui.controller_methods;
...
import static org.allvens.assets.Constants.FILE_CSS;
...
public class Common_ControllerMethods implements Constants_Prefs {
    ...
    protected void screen_SetSize(BorderPane bodyPane){
        if(!PROJECT_Prefs.getBoolean(SCREEN_Max, false)){
            bodyPane.setPrefWidth(PROJECT_Prefs.getDouble(SCREEN_Width, 800.0));
            bodyPane.setPrefHeight(PROJECT_Prefs.getDouble(SCREEN_Height, 800.0));
        }
    }
    ...
    private void changeDynamic_SaveWidth(BorderPane bpAll) {
        PROJECT_Prefs.putDouble(SCREEN_Width, bpAll.getWidth());
        PROJECT_Prefs.putDouble(SCREEN_Height, bpAll.getHeight());
    }
    ...
    public void changeScreen(int changeScreenSettings, String fxmlScreen, ActionEvent e, String windowTitle, BorderPane bpAll, boolean alwaysOnTop){
        ...
        if (stage.isFullScreen()) {
            ...
            PROJECT_Prefs.putBoolean(SCREEN_Max, true);
        }else{
            PROJECT_Prefs.putBoolean(SCREEN_Max, false);
        }
